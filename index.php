...
<body>
  <div class="header">
    <div class="row">
      ...
      <div class="col-md-3 ">
        <a href="#" data-toggle="modal" data-target="#login" style="color:lightyellow;font-size: 34px;font-weight: bold;margin: 15px;text-decoration: none;font-family: 'typo';">Admin Login</a>
      </div>
      <div class="col-md-0 col-md-offset-3">
        <a href="#" class="btn btn-primary logb" style="font-size: 30px;transform: rotateX(45deg); font-weight: bold;margin: 7px 30px;padding: 0px 20px;" data-toggle="modal" data-target="#myModal"> <span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<span class="title1" style="font-size:40px ;font-family:'typo';"><b> Login </b> </span></a>
      </div>
        ...
        <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-12 control-label" for="name"></label>
              <div class="col-md-12">
                <input id="name" name="name" placeholder="Enter your name" class="form-control input-md" type="text" value="<?php if (isset($_GET['name'])) {echo $_GET['name'];} ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="rollno" name="rollno" placeholder="Enter your Roll no (Ex.732116104***)" class="form-control input-md" type="text" value="<?php if (isset($_GET['rollno'])) {echo $_GET['rollno'];} ?>">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-12">
                <select id="branch" name="branch" placeholder="Select your branch" class="form-control input-md">
                  ...
                  <option value="MBA" <?php
                                      ...
                                      ?>>Master Of Bussiness Adminsitrator</option>
                  <option value="IT" <?php
                                      if (isset($_GET['branch'])) {
                                        if ($_GET['branch'] == "IT")
                                          echo "selected";
                  ...
                  <option value="BBA" <?php
                                      ...
                                      ?>>Bachlor Of Business Administrator</option>
                  ...
                  <option value="BBA(CA)" <?php
                                          if (isset($_GET['branch'])) {
                                            if ($_GET['branch'] == "IMSC")
                                              echo "selected";
                                          }
                                          ?>>Bachelor Of Business Administrator(Computer Application)</option>
                  <option value="MSC" <?php
                                      if (isset($_GET['branch'])) {
                                        if ($_GET['branch'] == "IMSC")
                                          echo "selected";
                                      }
                                      ?>>Master OF Computer Science</option>
  ...
  <div class="row footer">
    <div class="col-md-5 box">
      <span href="#" data-target="#login" style="color:lightyellow;font-size:20px;font-weight: bold;">Organized by Narendra Textile Agency <br><br></span>
    </div>
    <div class="col-md-5 box">
      <a href="feedback.php" style="color:lightyellow;font-size:20px;font-weight: bold;" onmouseover="this.style('color:yellow')" target="new">Feedback</a>
    </div>
