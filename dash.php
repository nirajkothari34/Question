Wrap<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title> Admin || Question Paper</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Question Paper</span></div>
<?php
...
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="dash.php?q=4">Add Question Paper</a></li>
        <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
?>><a href="dash.php?q=5">Remove Question Paper</a></li>
      </ul>
          </div>
  </div>
</nav>
